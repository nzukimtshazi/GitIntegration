<!-- app/views/priority/add.blade.php -->
        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::model(new App\Models\Priority(), ['route' => ['storePriority']]) !!}
                    ...
                    <a href="{!!URL::route('priorities')!!}" class="btn btn-info" role="button">Cancel</a>
